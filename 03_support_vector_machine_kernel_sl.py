""" support_vector_machine_kernel_sl
    --------------------------------
    Implementation of a kernel support vector machine via sci-kit learn.
"""
...
plt.savefig('images/03_support_vector_machine_kernel_sl/Scatter_plot_of_the_features.png')
...
plt.legend(loc='upper left')
plt.savefig('images/03_support_vector_machine_kernel_sl/Decision_boundary_and_training_sample.png')
