""" K_nearest_neighbor
    ------------------
    Implementation of a k-nearest neighbor classifier via sci-kit learn.
"""
...
plt.savefig('images/03_k_nearest_neighbor_sl/Scatter_plot_of_the_features.png')
...
print('Accuracy: {}'.format(knn.score(X_test_std, y_test)))


# ------------------------------------------------------------------------------------------------------------------------------------------
# 3. VISUALIZE THE DECISION BOUNDARIES AND VERIFY HOW WELL THE PERCEPTRON CLASSIFIES THE DIFFERENT SAMPLES
# ------------------------------------------------------------------------------------------------------------------------------------------
...
plt.legend(loc='upper left')
plt.savefig('images/03_k_nearest_neighbor_sl/Decision_boundary_and_training_sample.png')
