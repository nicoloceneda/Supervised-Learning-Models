...
│
├── 03_logistic_regression_gd_sl.py        <-- Implementation of a single layer logistic regression for multi-class classification, via gradient descent algorithm, with standardized
