...
plt.figure()
plt.scatter(X[:50, 0], X[:50, 1], color="red", edgecolor='black', marker="o", label="Setosa")
plt.scatter(X[50:100, 0], X[50:100, 1], color="blue", edgecolor='black', marker="o", label="Versicolor")
plt.scatter(X[100:150, 0], X[100:150, 1], color="lightgreen", edgecolor='black', marker="o", label="Virginica")
...
def plot_decision_regions(X, y, classifier, test_idx=None, resolution=0.02):
    ...
    for pos, cl in enumerate(np.unique(y)):
        plt.scatter(x=X[y==cl,0], y=X[y==cl,1], alpha=0.8, c=colors[pos], edgecolor='black', marker='o', label=cl)
