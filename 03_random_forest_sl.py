""" random_forest_sl
    ----------------
    Implementation of a decision tree via sci-kit learn.
"""
...
plt.savefig('images/03_random_forest_sl/Scatter_plot_of_the_features.png')
...
plt.legend(loc='upper left')
plt.savefig('images/03_random_forest_sl/Decision_boundary_and_training_sample.png')
