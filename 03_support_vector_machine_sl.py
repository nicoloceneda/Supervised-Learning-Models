""" support_vector_machine_sl
    -------------------------
    Implementation of a support vector machine via sci-kit learn.
"""
...
plt.savefig('images/03_support_vector_machine_sl/Scatter_plot_of_the_features.png')
...
plt.legend(loc='upper left')
plt.savefig('images/03_support_vector_machine_sl/Decision_boundary_and_training_sample.png')
